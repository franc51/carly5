...
@Component({
  selector: 'app-radiation-history',
  templateUrl: './radiation-history.component.html',
  styleUrl: './radiation-history.component.css'
})
export class RadiationHistoryComponent {
